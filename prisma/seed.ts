  ...
  await prisma.task.createMany({
    data: [
      // Tasks for Project 1
      {
        ...
        description: "Define folder structure, tooling, and CI/CD pipeline",
      ...
      },
      {
        ...
        description: "Create ERD and Prisma schema for products, orders, users",
        status: TaskStatus.done,
        priority: TaskPriority.high,
        position: 1,
        projectId: project1.id,
      ...
      },
      {
        ...
        description: "Order tracking, status updates, and notifications",
        status: TaskStatus.todo,
        priority: TaskPriority.medium,
        position: 1,
        projectId: project1.id,
  ...
  await prisma.task.createMany({
    data: [
      // Tasks for Project 2
      {
        ...
        description: "Conduct user interviews and define target personas",
        status: TaskStatus.done,
        priority: TaskPriority.high,
        position: 0,
