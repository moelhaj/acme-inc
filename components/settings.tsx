...
export function Settings() {
	const { isSettingOpen, setIsSettingOpen } = useApp();
	return (
								...
								<div className="[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold">
									<div className="space-y-4">
										...
										<div className="space-y-1">
											...
											<p>
												The website and its original content are protected
												by intellectual property laws. Users may not
												reproduce, distribute, modify, create derivative
												works, or commercially exploit any content without
										...
										<div className="space-y-1">
											...
											<p>
												The website provides content &ldquo;as is&ldquo;
												without any warranties. The website owners shall not
												be liable for direct, indirect, incidental,
										...
										<div className="space-y-1">
											...
											<ul className="list-disc pl-6">
												...
												<li>
													Comply with applicable local and international
													laws
												</li>
											</ul>
										</div>
										...
										<div className="space-y-1">
											...
											<p>
												The website reserves the right to modify these terms
												at any time. Continued use of the website after
										...
										<div className="space-y-1">
											...
											<p>
												The website may terminate or suspend user access
